...
base='....'
ADDON=xbmcaddon.Addon(id='plugin.video.drewzymods')
...
def CATEGORIES():
    link = OPEN_URL('https://drewzymods.000webhostapp.com/wizard.html').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR=orange]drewzymods Wizard[/COLOR]","[COLOR=orange]DOWNLOADING[/COLOR]",'', '[COLOR=orange]Please Wait[/COLOR]')
